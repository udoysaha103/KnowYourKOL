...
const ThumbsUp = ({ color, width, height }) => (
  <svg
...
const RateReview = ({ color, width, height }) => (
  <svg
    style={{ color, fill: color, maxWidth: width, height }}
    viewBox="0 0 24 24"
  >
...
const Crown = ({ color, width, height }) => (
  <svg
    style={{ color, fill: color, maxWidth: width, height }}
    viewBox="0 0 576 512"
  >
...
const RocketLaunch = ({ color, width, height }) => (
  <svg
    style={{ color, fill: color, maxWidth: width, height }}
    viewBox="0 0 24 24"
  >
...
const Skull = ({ color, width, height }) => (
  <svg
    style={{ color, fill: color, maxWidth: width, height }}
    viewBox="0 0 512 512"
  >
...
const Discord = ({ color, width, height }) => (
  <svg
    style={{ color, fill: color, maxWidth: width, height }}
    viewBox="0 0 640 512"
  >
...
const Telegram = ({ color, width, height }) => (
  <svg
    style={{ color, fill: color, maxWidth: width, height }}
    viewBox="0 0 496 512"
  >
...
const Icon = ({ name, color, width, height, onClick }) => {
  switch (name) {
    case "ThumbsUp":
      return <ThumbsUp color={color} width={width} height={height} />;
    case "ThumbsDown":
      return <ThumbsDown color={color} width={width} height={height} />;
    case "RateReview":
      return <RateReview color={color} width={width} height={height} />;
    case "Crown":
      return <Crown color={color} width={width} height={height} />;
    case "RocketLaunch":
      return <RocketLaunch color={color} width={width} height={height} />;
    case "Skull":
      return <Skull color={color} width={width} height={height} />;
    case "Twitter":
      return <Twitter color={color} width={width} height={height} />;
    case "Discord":
      return <Discord color={color} width={width} height={height} />;
    case "Telegram":
    ...
    case "Sort":
      return <Sort color={color} width={width} height={height} />;
    default:
      return null;
  }
};
