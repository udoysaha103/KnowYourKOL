...
const reviewSchema = new mongoose.Schema({
    ...
    reviewGiver: { type: mongoose.Schema.Types.ObjectId, ref: "userModel", required: true, unique: true },
    reviewReceiver: { type: mongoose.Schema.Types.ObjectId, ref: "verifiedKOLmodel", required: true },
